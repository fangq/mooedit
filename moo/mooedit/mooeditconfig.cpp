                ...
                GParamSpec     *pspec)
{
    ...
    g_slist_foreach (instances, (GFunc)(void(*)(void)) g_object_freeze_notify, NULL);
    g_slist_foreach (instances, (GFunc)(void(*)(void)) update_prop_from_global, prop_id);
    g_slist_foreach (instances, (GFunc)(void(*)(void)) g_object_thaw_notify, NULL);
...
moo_edit_config_install_setting (GParamSpec *pspec)
{
    ...
    g_slist_foreach (instances, (GFunc)(void(*)(void)) g_object_freeze_notify, NULL);
    g_slist_foreach (instances, (GFunc)(void(*)(void)) update_prop_from_global, GUINT_TO_POINTER (prop_id));
    g_slist_foreach (instances, (GFunc)(void(*)(void)) g_object_thaw_notify, NULL);
