                        ...
                        GSList        *deleted)
{
    ...
    g_slist_foreach (moved, (GFunc)(void(*)(void)) g_object_ref, NULL);
    g_slist_foreach (deleted, (GFunc)(void(*)(void)) g_object_ref, NULL);
    ...
    g_slist_foreach (deleted, (GFunc)(void(*)(void)) g_object_unref, NULL);
    g_slist_foreach (moved, (GFunc)(void(*)(void)) g_object_unref, NULL);
}
