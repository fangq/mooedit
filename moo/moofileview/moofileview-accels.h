...
#define MOO_FILE_VIEW_BINDING_GO_UP GDK_KEY_Up, GDK_META_MASK
#define MOO_FILE_VIEW_BINDING_GO_UP_KP GDK_KEY_KP_Up, GDK_META_MASK
#define MOO_FILE_VIEW_BINDING_GO_BACK GDK_KEY_bracketleft, GDK_META_MASK
#define MOO_FILE_VIEW_BINDING_GO_FORWARD GDK_KEY_bracketright, GDK_META_MASK
#define MOO_FILE_VIEW_BINDING_GO_HOME GDK_KEY_h, GDK_META_MASK | GDK_SHIFT_MASK
#define MOO_FILE_VIEW_BINDING_DELETE GDK_KEY_BackSpace, GDK_META_MASK
#define MOO_FILE_VIEW_BINDING_PROPERTIES GDK_KEY_i, GDK_META_MASK
