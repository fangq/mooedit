...
{                                                                       \
    return (ListType*) g_##glisttype##_copy ((GListType*) list);        \
                                                                        ...
                                                                        \
G_INLINE_FUNC G_GNUC_UNUSED guint                                                     \
...
template<typename T> G_INLINE_FUNC G_GNUC_UNUSED void                                 \
...
struct Element##Queue {                                                 \
  ...
  guint length;                                                         \
                                                                        ...
                                                                        \
G_INLINE_FUNC G_GNUC_UNUSED Element##Queue *                                          \
element##_queue_from_gqueue (GQueue *queue)                             \
{                                                                       \
    return (Element##Queue*) queue;                                     \
}                                                                       \
                                                                        \
G_INLINE_FUNC G_GNUC_UNUSED GQueue *                                                  \
