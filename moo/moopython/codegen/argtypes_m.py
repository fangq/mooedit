...
class Wrapper:
    ...
    noconstructor = (
        'static int\n'
        'pygobject_no_constructor(G_GNUC_UNUSED PyObject *self, G_GNUC_UNUSED PyObject *args, '
...
_wrap__get_symbol_names(G_GNUC_UNUSED PyObject *self)
{
...
""")
    ...
    def _write_get_symbol(self, writer, functions):
        self.fp.write("""static PyObject *
_wrap__get_symbol(G_GNUC_UNUSED PyObject *self, PyObject *args)
{
    PyObject *d;
    char *name;
...
def main(argv):
    ...
    for opt, arg in opts:
        if opt in ('-o', '--override'):
            ...
            # Python 3: Simple exec with proper globals
            globals_dict = {
                '__name__': '__main__',
                '__file__': arg,
